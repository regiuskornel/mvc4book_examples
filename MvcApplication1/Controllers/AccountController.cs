    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult ExternalLoginCallback(string returnUrl)
        {
            ...
            else
            {
                ...
                ViewBag.ReturnUrl = returnUrl;
                return View("ExternalLoginConfirmation", new RegisterExternalLoginModel { UserName = fullname, ExternalLoginData = loginData });
            }
        }
        ...
        #region SimpleRole
        //[Authorize(Roles = "Adminok",Users = "Pista, Marcsi")]
        [Infrastructure.AnotherAuthorizeAttribute(Roles = "Adminok")]
        public ActionResult RoleList()
        {
            SimpleRoleProvider simpleRoles = Roles.Provider as SimpleRoleProvider;
            var roles = simpleRoles.GetAllRoles().Select(r => new RoleModel(r));
            return View(roles);
        }
        ...
        {
            SimpleRoleProvider simpleRoles = Roles.Provider as SimpleRoleProvider;
            simpleRoles.DeleteRole(id, false);
            return RedirectToAction("RoleList");
        }

        public ActionResult RoleCreate()
        {
            return View(new RoleModel("Adj nevet"));
        }

        [HttpPost]
        [ActionName("RoleCreate")]
        public ActionResult RoleCreatePost(string name)
        {
            SimpleRoleProvider simpleRoles = Roles.Provider as SimpleRoleProvider;
            simpleRoles.CreateRole(name);
            return RedirectToAction("RoleList");
        }
